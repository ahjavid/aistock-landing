export default function CTA() {
  return (
    <section className="container-custom py-16">
      <div className="card max-w-4xl mx-auto text-center bg-gradient-to-r from-brand-primary/10 to-brand-surface border-2 border-brand-primary/30">
        <h2 className="text-3xl md:text-4xl font-bold text-brand-text mb-4">
          Ready to Explore?
        </h2>
        <p className="text-lg text-brand-text-secondary mb-8 max-w-2xl mx-auto">
          Review the complete backtest results, explore the system architecture, or dive into the source code.
        </p>
