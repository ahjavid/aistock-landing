export default function Features() {
  const features = [
    ...
    },
    {
      ...
      description: 'Live performance tracking, equity curves, and comprehensive backtest validation.'
    },
    {
      icon: (
        <svg className="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    },
    {
      ...
      description: 'Comprehensive documentation, transparent methodology, and academic-grade backtesting.'
    }
  ];
    ...
    <section className="container-custom py-16">
      <div className="text-center mb-12">
        ...
        <p className="text-lg text-brand-text-secondary max-w-2xl mx-auto">
          A sophisticated trading research platform combining cutting-edge ML with production engineering
        </p>
      </div>

      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
        {features.map((feature, index) => (
          <div key={index} className="card hover:ring-brand-primary/50 transition-all duration-300 animate-slide-up">
